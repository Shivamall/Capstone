        ...
        if (date >= lastFullDateSelected) {
            ...
            if currentCycleDays >= noOfDaysItLastValue {
                if currentCycleDays < noOfDaysItLastValue + 2 {
                   currentCell.bgView.backgroundColor = #colorLiteral(red: 0.5568627715, green: 0.3529411852, blue: 0.9686274529, alpha: 1)
                } else if currentCycleDays < lengthOfCycleDaysValue - 2 {
                   
                    currentCell.bgView.backgroundColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
                } else {
                      currentCell.bgView.backgroundColor = #colorLiteral(red: 0.8078431487, green: 0.02745098062, blue: 0.3333333433, alpha: 1)
                }
            } else {
              currentCell.bgView.backgroundColor = #colorLiteral(red: 0.9098039269, green: 0.4784313738, blue: 0.6431372762, alpha: 1)
            }
        }
        return cell
